      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center">
            <a href="/" className="text-2xl font-bold text-[#2E5A51] cursor-pointer" style={{ fontFamily: "Pacifico, serif" }}>
              DoodyCalls
            </a>
          </div>
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <a href="/blog" className="text-gray-700 hover:text-[#2E5A51] transition-colors cursor-pointer">
              Blog
            </a>
