  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        <img 
          src="https://readdy.ai/api/search-image?query=Beautiful%20clean%20HOA%20community%20park%20with%20modern%20dog%20waste%20stations%2C%20well-maintained%20green%20grass%2C%20walking%20paths%2C%20families%20with%20dogs%20enjoying%20the%20space%2C%20bright%20sunny%20day%2C%20professional%20maintenance%2C%20welcoming%20neighborhood%20environment%2C%20clean%20sidewalks%2C%20pet-friendly%20community%20setting&width=1920&height=1080&seq=hero-bg-dog-station&orientation=landscape"
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className={`transform transition-all duration-1000 ${
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-[#2E5A51] mb-8 leading-tight">
            DoodyCalls Dog Station
            <br />
            <span className="text-[#F28C28] drop-shadow-lg">Services</span>
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
            Keeping your community clean and pet-friendly has never been easier.
            <br />
            At DoodyCalls of Wake County, we specialize in pet waste management solutions for HOAs, property managers, and community associations.
            <br />
            Our professional team ensures your dog waste stations stay functional, fully stocked, and visually appealing through consistent, high-quality service.
          </p>
