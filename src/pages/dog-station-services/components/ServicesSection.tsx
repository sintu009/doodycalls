  ...
  const services = [
    {
      ...
      description: 'We perform weekly service visits that include emptying waste cans, replenishing bags, and cleaning within a six-foot radius of each station. Our goal is to maintain a clean, odor-free environment while enhancing the look and hygiene of your property.'
    },
    {
      icon: 'ri-box-3-line',
      title: 'Inventory Management',
      description: 'Our team carefully monitors bag usage and restocks dispensers on schedule to ensure continuous availability. We track usage trends to optimize supply levels, minimizing waste while ensuring your residents never face an empty station.'
    },
    {
      icon: 'ri-search-eye-line',
      title: 'Inspection & Reporting',
      description: 'Every visit includes a thorough inspection of each dog waste station. We proactively identify damage or vandalism and provide a detailed service report with photos, estimated repair costs, and completion timelines — giving HOA boards and property managers full transparency and peace of mind.'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-[#2E5A51] mb-6">
            Station Service <span className="text-[#F28C28]">Key Components</span>
          </h2>
        </div>
