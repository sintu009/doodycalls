      ...
      <div className="max-w-6xl mx-auto px-6 text-center">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
            At DoodyCalls of Wake County, we provide comprehensive dog waste
            station maintenance for HOAs, multi‑family communities, and
            dog‑friendly business - keeping stations functional, fully stocked,
