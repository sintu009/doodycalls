  ...
  const steps = [
    {
      ...
      description: 'We map your stations and assess high-traffic areas to understand your specific needs'
    },
    {
      number: '02',
      icon: 'ri-calendar-line',
      title: 'Service Plan',
      description: 'Create a customized schedule and determine optimal stocking levels for your property'
    },
    {
      number: '03',
      icon: 'ri-settings-line',
      title: 'Onboarding',
      description: 'Complete first clean, set up inventory systems, and establish reporting protocols'
    },
    {
      number: '04',
      icon: 'ri-refresh-line',
      title: 'Ongoing Care',
      description: 'Weekly service visits with monthly summary reports to keep you informed'
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            From initial assessment to ongoing maintenance, we make it easy to keep your community clean
          </p>
        </div>
        ...
        <div className={`transform transition-all duration-1000 ${
          ...
          <div className=" bg-[#639e77] rounded-3xl p-8 text-center text-white shadow-2xl">
            ...
            <button className="bg-white text-[#2E5A51] px-10 py-4 rounded-2xl text-lg font-semibold hover:shadow-xl transform hover:scale-105 transition-all duration-300 whitespace-nowrap cursor-pointer">
