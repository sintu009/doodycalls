  ...
  const services = [
    {
      ...
      description: 'Weekly visits to empty cans, replace bags, and clean within a 6-foot radius.',
      outcome: 'Sanitary, odor-free, and tidy common areas for your community.'
    },
    {
      icon: 'ri-box-3-line',
      title: 'Inventory Management',
      description: 'Track usage and restock on schedule to prevent outages.',
      outcome: 'Optimize supply levels to reduce waste and control costs effectively.'
    },
    {
      icon: 'ri-search-eye-line',
      title: 'Inspection & Reporting',
      description: 'Inspect each station and document wear or vandalism issues.',
      outcome: 'Photo reports after service with issues, estimates, and timelines.'
    }
  ];

  return (
    <section ref={sectionRef} className="relative py-24 bg-gradient-to-br from-[#F6F6F6] via-white to-[#FDF8F3]">
      <div className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Professional maintenance solutions designed to keep your community clean and welcoming
          </p>
        </div>
        ...
        <div className={`text-center transform transition-all duration-1000 ${
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-xl border border-white/50 inline-flex items-center space-x-4 max-w-md mx-auto">
            ...
            <div className="text-left">
              <div className="font-bold text-[#2E5A51] text-lg">Uniformed, Trained Technicians</div>
              <div className="text-gray-600">Fully insured and professional service</div>
            </div>
          </div>
        </div>
      </div>
