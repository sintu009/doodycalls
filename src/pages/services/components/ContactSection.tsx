        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              We're happy to help answer your questions and discuss your
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 group">
                ...
                <div>
                  <div className="text-sm font-semibold text-[#2E5A51] mb-1">
                    Call Us
                  </div>
                  <a
                    href="tel:919-634-5383"
                    className="text-2xl font-bold text-[#F28C28] hover:text-[#e07a1f] transition-colors duration-300"
                  >
                    919-634-5383
                  </a>
                </div>
          ...
          >
            <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-10 shadow-2xl border border-white/50 relative overflow-hidden">
              ...
              <div className="relative z-10 text-center">
                <div className="w-20 h-20  bg-[#2E5A51] rounded-full flex items-center justify-center mx-auto mb-6">
                ...
                <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                  Schedule your free site evaluation and discover how we can
                  help keep your community clean and welcoming.
                </p>

                <div className="space-y-4">
                  <button
                    onClick={() => setIsQuoteOpen(true)}
                    className="w-full bg-gradient-to-r from-[#F28C28] to-[#e07a1f] text-white px-8 py-4 rounded-xl text-lg font-semibold hover:shadow-2xl hover:shadow-[#F28C28]/50 transform hover:scale-105 transition-all duration-300 whitespace-nowrap cursor-pointer"
                  >
                  ...
                  <button
                    onClick={() => {
                      window.location.href =
                        "mailto:gmann@doodycalls.com?subject=Contact%20Request";
                    }}
                    className="w-full border-2 border-[#2E5A51] text-[#2E5A51] px-8 py-4 rounded-xl text-lg font-semibold hover:bg-[#2E5A51] hover:text-white transition-all duration-300 whitespace-nowrap cursor-pointer"
                  >
                    Email Our Team
                  </button>
                </div>
