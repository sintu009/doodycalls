...
export default function HeroSection() {
  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#F6F6F6] via-white to-[#FDF8F3] overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 text-center">
        <div className={`transform transition-all duration-1000 ${
          ...
          <h1 className="text-5xl md:text-7xl font-bold text-[#2E5A51] mb-8 leading-tight">
            ...
            <br />
            <span className="text-[#F28C28] drop-shadow-lg">Clean, Safe & Pet-Friendly</span>
            <br />
            Communities
          </h1>
          
          <p className="text-xl md:text-2xl text-gray-700 mb-12 max-w-4xl mx-auto leading-relaxed font-medium">
            We maintain and manage your dog waste stations so your property stays fresh, 
            functional, and welcoming for all residents and their pets.
          </p>
        ...
        <div className={`transform transition-all duration-1000 ${
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-8 shadow-2xl border border-white/50 max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
              <div className="group">
                <div className="text-4xl font-bold text-[#F28C28] mb-2 group-hover:scale-110 transition-transform duration-300">100+</div>
                <div className="text-[#2E5A51] font-semibold text-lg">Stations Serviced</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-[#F28C28] mb-2 group-hover:scale-110 transition-transform duration-300">30+</div>
                <div className="text-[#2E5A51] font-semibold text-lg">Communities Served</div>
              </div>
              <div className="group">
                <div className="text-4xl font-bold text-[#F28C28] mb-2 group-hover:scale-110 transition-transform duration-300">25</div>
                <div className="text-[#2E5A51] font-semibold text-lg">Years of Experience</div>
              </div>
            </div>
          </div>
        </div>
