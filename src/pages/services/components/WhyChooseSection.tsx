...
export default function WhyChooseSection() {
  ...
  const benefits = [
    ...
    },
    {
      ...
      description: 'Visual documentation of every service visit with detailed reports'
    },
    {
      icon: 'ri-tools-line',
      title: 'Fast Repairs & Special Requests',
      description: 'Quick response to maintenance issues and custom service needs'
    },
    {
      icon: 'ri-heart-line',
      title: 'Local Team That Cares',
      description: 'Community-focused professionals who understand your property'
    },
    {
      icon: 'ri-award-line',
      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className={`text-center mb-16 transform transition-all duration-1000 ${
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Experience the difference of working with Wake County's most trusted dog waste management professionals
          </p>
        </div>
