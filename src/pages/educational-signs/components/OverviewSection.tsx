...
export default function OverviewSection({ isVisible }: OverviewSectionProps) {
  return (
    <section id="overview" data-animate className="py-20 bg-white">
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-4xl mx-auto leading-relaxed mb-8">
            DoodyCalls of Wake County provides Educational Dog Waste Ordinance
            Signs designed to remind residents and visitors of local "Pooper
            Scooper" laws. These signs display ordinance numbers, fines, and
            contact information — helping property managers and HOAs reduce pet
            waste issues and promote environmental care.
          </p>
          ...
          <div className="bg-[#F6F6F6] rounded-2xl p-8 max-w-3xl mx-auto">
            <div className="flex items-center justify-center mb-4">
              ...
              <span className="text-[#2E5A51] font-semibold text-lg">
                Exclusively Provided
              </span>
            </div>
            <p className="text-gray-700 text-lg">
              All educational signs are exclusively provided by{" "}
              <strong>GreenWalks, LLC</strong> – DBA DoodyCalls of Wake County.
            </p>
          </div>
        </div>
          ...
          <div className="space-y-6">
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Inform residents about local pet waste laws and regulations
                  with professional signage.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Display ordinance numbers and fine amounts to ensure community
                  compliance.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Promote environmental responsibility and maintain clean,
            ...
            <Link
              to="/blog"
              className="inline-block bg-[#F28C28] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#e07a1f] transition-colors duration-200 whitespace-nowrap"
            >
              Learn More
            </Link>
          </div>
