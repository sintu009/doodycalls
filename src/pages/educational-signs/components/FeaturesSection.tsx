      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Every sign is engineered to withstand the elements while delivering
        ...
        <div
          className={`bg-[#2E5A51] rounded-2xl p-8 text-center text-white transform transition-all duration-1000 ${
            isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"
          }`}
        >
          <p className="text-lg mb-6 max-w-4xl mx-auto">
            These signs integrate seamlessly with DoodyCalls Pet Waste Stations
