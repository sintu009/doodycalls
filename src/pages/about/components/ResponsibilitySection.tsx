        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed mb-8">
              Every HOA, park, and shared property tells a story. Some show
              frustration — overflowing bins, complaints, neglected areas.
              Others tell a story of care. That difference is leadership.
            </p>
            <p className="text-lg md:text-xl text-gray-700 leading-relaxed">
              We partner with community managers who see cleanliness as respect
              — for residents, pets, and the planet.
            </p>
          </div>
          ...
          >
            <div className="space-y-4">
              <img
                src="https://res.cloudinary.com/dfnsp8dlj/image/upload/v1764084837/dreamstime_xxl_384788855_1_ghnyjx.jpg"
                alt="HOA Community"
            ...
            <div className="space-y-4 mt-8">
              <img
                src="https://res.cloudinary.com/dfnsp8dlj/image/upload/v1764086409/dreamstime_xxl_3475817_2_evls9e.jpg"
