      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          ...
          <p className="text-xl text-gray-200 max-w-4xl mx-auto leading-relaxed">
            DoodyCalls products are designed to make communities cleaner and
            greener. From durable aluminum construction to eco-friendly bag
            options, every item reflects our commitment to sustainability.
          </p>
        </div>
