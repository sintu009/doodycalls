...
export default function MasterChiefSection({
  isVisible,
}: MasterChiefSectionProps) {
  const includes = [
        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              The Master Chief delivers DoodyCalls' trusted performance and
              simplicity in a compact, affordable model. It's ideal for areas
              with existing trash cans where dependable access to dog waste bags
              is needed.
            </p>
            ...
            <div className="mb-8">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-center text-gray-600">
                  <i className="ri-check-line text-[#F28C28] mr-3 text-lg"></i>8
                  ft. square steel post
                </li>
                <li className="flex items-center text-gray-600">
                  <i className="ri-check-line text-[#F28C28] mr-3 text-lg"></i>
                  Installation provided by DoodyCalls
            ...
            <div className="bg-[#F6F6F6] p-6 rounded-lg mb-8">
              <h4 className="text-lg font-bold text-[#2E5A51] mb-2">
                Best For:
              </h4>
          ...
          >
            <img
              src="https://res.cloudinary.com/dfnsp8dlj/image/upload/v1764090714/masterchief_r8996p.png"
