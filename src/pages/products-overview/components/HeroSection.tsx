      ...
      >
        ...
        >
          ...
          <p className="text-xl md:text-2xl text-white/90 mb-12 max-w-4xl mx-auto leading-relaxed">
            Innovative design. Incredible value. Cleaner, smarter spaces for
            everyone.
          </p>
          <button
            onClick={() => setIsQuoteOpen(true)}
            className="bg-[#F28C28] text-white px-12 py-4 rounded-full text-xl font-semibold hover:bg-[#e07a1f] transition-all duration-300 transform hover:scale-105 whitespace-nowrap cursor-pointer"
          >
