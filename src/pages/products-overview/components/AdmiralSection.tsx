        ...
        >
          <div className={`transform transition-all duration-1000 ${
            ...
            <p className="text-lg text-gray-600 mb-8 leading-relaxed">
              The Admiral is DoodyCalls' premium model — perfect for communities that prioritize odor control and aesthetics. 
              Its double-can, non-perforated design traps odors completely, while a mailbox-style chute prevents misuse with household trash.
            </p>

            <div className="mb-8">
              <h4 className="text-xl font-bold text-[#2E5A51] mb-4">Key Features:</h4>
            ...
            <div className="bg-gradient-to-r from-[#2E5A51] to-[#3a6b61] text-white p-6 rounded-lg mb-8">
              ...
              <p>
                Playgrounds, luxury communities, pet-friendly restaurants, and veterinary clinics.
              </p>
            </div>
          ...
          <div className={`transform transition-all duration-1000 ${
            ...
            <img 
              src="https://readdy.ai/api/search-image?query=Premium%20luxury%20pet%20waste%20station%20with%20enclosed%20design%20and%20odor%20control%20features%2C%20installed%20in%20upscale%20community%20setting%20with%20beautiful%20landscaping%2C%20showing%20sophisticated%20construction%20and%20high-end%20aesthetic%20appeal%20for%20sensitive%20areas&width=600&height=700&seq=admiral-station&orientation=portrait"
